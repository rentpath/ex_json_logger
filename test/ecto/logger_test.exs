  ...
  describe "log/2" do
    test "entry values are formatted and put into metadata" do
      ...
      entry = %{
        ...
        params: [
          1,
          "20170504-373-cb4150f",
          {{2017, 5, 10}, {21, 34, 53, 998_254}},
          {{2017, 5, 10}, {21, 34, 53, 998_264}}
        ]
      }
      ...
      assert message =~
               "query_params=[1, \"20170504-373-cb4150f\", {{2017, 5, 10}, {21, 34, 53, 998254}}, {{2017, 5, 10}, {21, 34, 53, 998264}}]"
    end
  end
end
